...
# 4) Code strips off page numbers.
	# ADD: further ranks (Series, subgenus, etc.) - Do Later whenever encountered.
...
while (<IN>) {
	# Marks up KEYTITLES:
	s/(^(?:(?:ARTIFICIAL |NEW |ORIGINAL |REVISED |SHORT |SCIENTIFIC |TENTATIVE |)KEY|REGIONAL KEY))(.+|)($)/\t\t\t<key>\n\t\t\t\t<keyTitle>$1$2$3<\/keyTitle>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+)( \(p\. \d+\)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$7\">$9$10$11$12<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+)( \(p\. \d+\)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7$8$9$10<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$7\">$9$10$11$12<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7$8$9$10<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )((forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. |sect. |[[:upper:]]\w*\. )([[:lower:]]\w+|[[:upper:]]\w+))( \(p\. \d+\)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$7\">$9<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )((forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. |sect. |[[:upper:]]\w*\. )([[:lower:]]\w+$|[[:upper:]]\w+$))/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$7\">$9<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+)(\. )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|))( \(p\. \d+\)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	
	# Marks up b. and c. leads ending on a number + taxon name ("1. Cornus"):
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )(\d+)(\. )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$7\">$9<\/toTaxon>\n\t\t\t\t\t<\/question>/;
		
		
	# Marks up b. and c. leads ending on a taxon name + page number ("Cornus (p. 123)") (wipes page number):
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|))( \(p\. \d+\)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	
	# Marks up b. and c. leads ending on a taxon name ("Cornus"):
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|)$)/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	# Marks up b. and c. leads ending on a genus abbreviation + species epithet + author name:
	s/(^)(b|c|d)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\. [[:lower:]-]+ )((?:\((?:BEDD\.|F\.v\.M\.|K\.SCH\.|KOSTERM\.|L\.f\.|LINDL\.|MAID\. & R\. T\. BAKER|OLIV\.|STEEN\.)\) |)(?:BEDD\.|F\.v\.M\.|K\.SCH\.|KOSTERM\.|L\.f\.|LINDL\.|MAID\. & R\. T\. BAKER|OLIV\.|STEEN\.))/$1\t\t\t\t\t<question num=\"$2\">\n\t\t\t\t\t\t<text>$4$5<\/text>\n\t\t\t\t\t\t<toTaxon>$7$8<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+)( \(p\. \d+\)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$8\">$10$11$12$13<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+)( \(p\. \d+\)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon>$8$9$10$11<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$8\">$10$11$12$13<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+ |[[:upper:]]\. )([[:lower:]]\w+ )(forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. )([[:lower:]]\w+$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon>$8$9$10$11<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )((forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. |sect. |[[:upper:]]\w*\. )([[:lower:]]\w+|[[:upper:]]\w+))( \(p\. \d+\)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$8\">$10<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(\d+|[[:lower:]]|\d+[[:lower:]])(\. )((forma |form |f\. |var\. |subsp\. |ssp\. |subforma |subform |subvar\. |sect. |[[:upper:]]\w*\. )([[:lower:]]\w+(?: p\.p\.| spp\.| \(partly\)|)$|[[:upper:]]\w+$))/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$8\">$10<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(\d+)(\. )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon num=\"$8\">$10<\/toTaxon>\n\t\t\t\t\t<\/question>/;
		
		
	# Marks up a. leads ending on a taxon name + page number ("Cornus (p. 123)") (wipes page number):
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|))( \(p\. \d+\)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon>$8<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	
	# Marks up a. leads ending on a taxon name ("Cornus"):
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\w+(?: p\.p\.| spp\.| \(partly\)|)$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon>$8<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	...
	# Marks up a. leads ending on a genus abbreviation + species epithet + author name:
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )([[:upper:]]\. [[:lower:]-]+ )((?:\((?:BEDD\.|F\.v\.M\.|K\.SCH\.|KOSTERM\.|L\.f\.|LINDL\.|MAID\. & R\. T\. BAKER|OLIV\.|STEEN\.)\) |)(?:BEDD\.|F\.v\.M\.|K\.SCH\.|KOSTERM\.|L\.f\.|LINDL\.|MAID\. & R\. T\. BAKER|OLIV\.|STEEN\.))/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toTaxon>$8$9<\/toTaxon>\n\t\t\t\t\t<\/question>/;
	
	
	# Marks up a. leads ending on a reference to another key ("See Key to introduced species"):
	s/(^)(\d+)(a)(\. )([[:upper:]♂♀])(.+)( )(See Key to introduced species$)/$1\t\t\t\t<\/couplet>\n\t\t\t\t<couplet num=\"$2\">\n\t\t\t\t\t<question num=\"$3\">\n\t\t\t\t\t\t<text>$5$6<\/text>\n\t\t\t\t\t\t<toKey ref="">$8<\/toKey>\n\t\t\t\t\t<\/question>/;
	
	# Moves "p.p." out of toTaxon tags into keynotes tags:
	s/( )(p\.p\.)(<\/toTaxon>)/$3<keynotes>$2<\/keynotes>/;
