...
# Ci-dessous: formats utilises dans Flora Malesiana pour les clés, sur lesquels les formats pour Flore du Gabon sont basés. Les formats FM sont désactivés dans ce script.
