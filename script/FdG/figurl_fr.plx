...
while (<IN>) {
	...
	# "fdg" for "Flore du Gabon"
	# - (dash)
	# "volume number" in digits - Change this to the volume number you need to use for this particular FdG volume
	# - (dash)
	...
	s/(<figure id="ID_)(\d+)(" type=")(lineart)(">)/$1$2$3$4" url="fdg-16-$2.gif$5/g;
	
	# Photos, which usually will be .jpg files:
	s/(<figure id="ID_)(\d+)(" type=")(photo)(">)/$1$2$3$4" url="fdg-16-$2.jpg$5/g;
